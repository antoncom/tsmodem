...
local rule_setting = {
    ...
    lowbalance_timer = {
		...
		subtotal = nil,
        modifier = {
			["1_logicfunc"] = [[ if ( (tonumber("sim_balance") ~= nil) and ("sim_balance" ~= "-999") and ("sim_balance" ~= "-998") ) then return true else return false end ]],
	...
	event_switch_state = {
		...
		modifier = {
			["1_formula"] = [[ if (
				...
				and ( ("sim_balance" ~= "-999") and ("sim_balance" ~= "-998") )
